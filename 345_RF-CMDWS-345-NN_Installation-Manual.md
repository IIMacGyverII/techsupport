...
- [Installation Guidelines](#page-1) *(Page 1)*
- [Programming](#page-1) *(Page 1)*
- [Testing the Sensor](#page-1) *(Page 1)*
  - [Mounting the Sensor](#page-2) *(Page 2)*
  - [Mounting Screws](#page-2) *(Page 2)*
  - [Double-Sided Tape](#page-2) *(Page 2)*
  - [For Additional Tamper Security](#page-2) *(Page 2)*
  - [Specifications](#page-2) *(Page 2)*
...
RF-CMDWS-345-NN Installation Instructions
...
• Mount the sensor within the range of the
panel.
...
• The magnet should be mounted within 5/8”
of the sensor. Based on the magnet
mounting spacing, direction of operation,
and material of the mounting surface, the
gap for opening may vary between
depending on application. Desired operation
**Note:** If a low battery alarm occurs, replace
the battery within 7 days.

I-RF-CMDWS-345-NN Rev.4  Oct. 2020   For updated Installation Manual Revision go to maxouttech.com and select Documentation page.

![Image 1 on page 1](images/b_rf_cmdws_345_nn_im_p1_img1.png)
...
![Image 1 on page 2](images/b_rf_cmdws_345_nn_im_p2_img1.png)
